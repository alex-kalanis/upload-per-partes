...
class ResponseTest extends CommonTestClass
{
    ...
    {
        $lib = $this->getLib()->init($this->getDataResponse('{"serverKey":"my_server","status":"OK","message":"OK","name":"which one","totalParts":813143,"lastKnownPart":54531,"partSize":1853,"encoders":"code","checksum":"sum"}'), 'pass back');
        /** @var Responses\InitResponse $lib */
